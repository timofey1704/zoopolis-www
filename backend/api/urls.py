...
urlpatterns = [
    ...
    path('v1/login/refresh/', RefreshTokenCookieView.as_view(), name="token-refresh-cookie"),
    ...
    path('v1/validate-qr-sms/', CheckCodeView.as_view({'post': 'verify_sms_code'}), name="verify_sms_code"),
